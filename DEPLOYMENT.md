...
```json
{ "success": true, "data": { "status": "ok", "name": "Linketry", "version": "0.29.17" } }
```
...
| `LINKETRY_APPROVED_RELEASE`           | `0.29.17`            | Must match the root package version                                       |
