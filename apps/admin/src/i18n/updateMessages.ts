export const updateMessages = {
  en: {
    ...
    viewUpdateDetails: 'View update',
    viewUpgradeProgress: 'View progress',
    upgradeOnline: 'Upgrade online',
    openDeployment: 'Open deployment',
    checkForUpdates: 'Check for updates',
    checkingForUpdates: 'Checking for updates',
    sidebarUpdateAvailable: 'v{version} available',
    sidebarUpgradeInProgress: 'Upgrade in progress',
    sidebarUpgradeFailed: 'Upgrade needs attention',
    ...
    versionCenterTitle: 'Version Center',
    versionCenterDescription:
      'Review the installed release, check deployment readiness, and follow the protected upgrade from one place.',
    ...
    upgradeProgressTitle: 'Protected deployment progress',
    upgradeCompleteTitle: 'Deployment verified',
    upgradeFailureTitle: 'Upgrade needs attention',
    retryUpgrade: 'Retry upgrade',
    upgradeStepPrepare: 'Start protected deployment',
    upgradeStepQueue: 'Wait for GitHub Actions',
    upgradeStepDeploy: 'Deploy Worker and Admin',
    upgradeStepVerify: 'Verify runtime and Admin assets',
  ...
  'zh-CN': {
    ...
    viewChanges: '查看变更',
    viewDeployment: '查看部署',
    viewUpdateDetails: '查看更新',
    viewUpgradeProgress: '查看进度',
    upgradeOnline: '在线升级',
    openDeployment: '打开部署',
    checkForUpdates: '检查更新',
    checkingForUpdates: '正在检查更新',
    sidebarUpdateAvailable: '可更新至 v{version}',
    sidebarUpgradeInProgress: '升级正在进行',
    sidebarUpgradeFailed: '升级需要处理',
    ...
    versionCenterTitle: '版本中心',
    versionCenterDescription: '在一个位置核对版本、检查部署能力，并跟踪受保护的在线升级流程。',
    ...
    upgradeProgressTitle: '受保护的部署进度',
    upgradeCompleteTitle: '部署已验证',
    upgradeFailureTitle: '升级需要处理',
    retryUpgrade: '重试升级',
    upgradeStepPrepare: '启动受保护的部署',
    upgradeStepQueue: '等待 GitHub Actions',
    upgradeStepDeploy: '部署 Worker 和 Admin',
    upgradeStepVerify: '验证运行版本与后台资源',
