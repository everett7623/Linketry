...
- **v0.31.3** is live on production, the isolated Demo, and `linketry.com`; remaining Pre-1.0 work is owner evidence (screen-reader, Quick Deploy rehearsal, remote D1, Demo R2)
