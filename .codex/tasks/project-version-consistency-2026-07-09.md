...
- [x] Bumped Linketry workspace package versions to `0.7.0`.
- [x] Updated `package-lock.json` workspace versions.
- [x] Added shared `LINKETRY_VERSION` constant.
...
- [x] Updated GitHub Actions `LINKETRY_VERSION` repository variable to `0.7.0`.
- [x] Updated GitHub Actions Node runtime to Node 24.
- [x] Made Worker `LINKETRY_VERSION` env type optional to match docs and fallback behavior.
